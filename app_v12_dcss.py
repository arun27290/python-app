...
def analyse(df_raw):
    ...
    if F["HPD_CI"]:
        ...
        if F["AssignedGroup"]:
            for gname, gdf in df.groupby("AssignedGroup"):
                # CIs within this group that have >= 3 incidents globally
                ...
                ci_rows = [{"HPD_CI": r["HPD_CI"],
                             "count":  int(r["count"]),
                             "pct":    round(int(r["count"]) / max_c * 100)}
        ...
        return `<div class="grp-panel">
          ...
          <div class="grp-body">
            ...
            <div class="tbl-wrap"><table>
              <thead><tr><th>#</th><th>HPD_CI</th><th>Incidents in this Group</th><th>Volume</th></tr></thead>
